                                                                                                                                                                    #Environment Variables: Create a shell script that sets, exports, and
#displays environment variables. Use printenv and env to show the
#current environment settings.
#These variables typically contain information about the system's environment, such as user settings, system paths, or configuration details etc...
#!/bin/bash
